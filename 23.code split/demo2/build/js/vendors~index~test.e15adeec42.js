       ...
       */ !(function (t, n) {
          ...
          C.extend({
            ...
            isPlainObject: function (e) {
              ...
              return (
                ...
                (!(t = a(e)) || ('function' == typeof (n = d.call(t, 'constructor') && t.constructor) && h.call(n) === g))
              )
            },
                    ...
                    : function (t, n, u) {
                        ...
                        if (v) {
                          ...
                          if (((h = [a ? v.firstChild : v.lastChild]), a && m)) {
                            for (
                              x =
                                (d = (l = (c = (f = (p = v)[b] || (p[b] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === T && l[1]) &&
                                l[2],
                                p = d && v.childNodes[d];
                            ...
                            : function () {
                                try {
                                  ...
                                  C.Deferred.exceptionHook && C.Deferred.exceptionHook(n, c.stackTrace),
                                    e + 1 >= o && (r !== W && ((s = void 0), (u = [n])), t.rejectWith(s, u))
                                }
                              }
        ...
        ;(C.fn.ready = function (e) {
          ...
          'complete' === x.readyState || ('loading' !== x.readyState && !x.documentElement.doScroll)
            ...
            : (x.addEventListener('DOMContentLoaded', _), n.addEventListener('load', _))
        ...
        ;(J.uid = 1),
          (J.prototype = {
            cache: function (e) {
              ...
              return (
                t ||
                  ((t = {}), Y(e) && (e.nodeType ? (e[this.expando] = t) : Object.defineProperty(e, this.expando, { value: t, configurable: !0 }))),
                t
              )
            },
            set: function (e, t, n) {
              ...
              C.event.add(e, t, {
                ...
                handler: function (e) {
                  ...
                  if (1 & e.isTrigger && this[t]) {
                    ...
                    o.length &&
                      (Q.set(this, t, { value: C.event.trigger(C.extend(o[0], C.Event.prototype), o.slice(1), this) }), e.stopImmediatePropagation())
                },
              }))
        ...
        ;(C.event = {
                ...
                if (1 === l.nodeType && ('click' !== e.type || !0 !== l.disabled)) {
                  for (o = [], a = {}, n = 0; n < u; n++)
                    void 0 === a[(i = (r = t[n]).selector + ' ')] &&
                      (a[i] = r.needsContext ? C(i, this).index(l) > -1 : C.find(i, this, null, [l]).length),
                      a[i] && o.push(r)
          ...
          special: {
            ...
            click: {
              setup: function (e) {
                var t = this || e
                return ge.test(t.type) && t.click && D(t, 'input') && je(t, 'click', ke), !1
              },
              trigger: function (e) {
                var t = this || e
          ...
          C.fn.extend({
            ...
            off: function (e, t, n) {
              ...
              if (e && e.preventDefault && e.handleObj)
                return (
                  (r = e.handleObj), C(e.delegateTarget).off(r.namespace ? r.origType + '.' + r.namespace : r.origType, r.selector, r.handler), this
                )
              if ('object' == typeof e) {
        ...
        function Me(e, t) {
          ...
          if (1 === t.nodeType) {
            if (Q.hasData(e) && (s = Q.get(e).events))
              for (i in (Q.remove(t, 'handle events'), s)) for (n = 0, r = s[i].length; n < r; n++) C.event.add(t, i, s[i][n])
        ...
        function We(e, t, n, r) {
          ...
          if (p && ((o = (i = Te(t, e[0].ownerDocument, !1, e, r)).firstChild), 1 === i.childNodes.length && (i = o), o || r)) {
            for (s = (a = C.map(xe(i, 'script'), Pe)).length; f < p; f++)
              (l = i), f !== d && ((l = C.clone(l, !0, !0)), s && C.merge(a, xe(l, 'script'))), n.call(e[f], l, f)
            if (s)
        ...
        C.extend({
          ...
          C.each({ appendTo: 'append', prependTo: 'prepend', insertBefore: 'before', insertAfter: 'after', replaceAll: 'replaceWith' }, function (
            e,
            t
          ) {
            C.fn[e] = function (e) {
          ...
          style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
              var i,
                ...
                u = Ke.test(t),
                l = e.style
              if ((u || (t = Je(s)), (a = C.cssHooks[t] || C.cssHooks[s]), void 0 === n))
          ...
          (it.propHooks = {
            _default: {
              ...
              set: function (e) {
                C.fx.step[e.prop]
                  ? C.fx.step[e.prop](e)
                  : 1 !== e.elem.nodeType || (!C.cssHooks[e.prop] && null == e.elem.style[Je(e.prop)])
                  ? (e.elem[e.prop] = e.now)
        ...
        function dt(e, t, n) {
          var r,
            ...
            u = function () {
              if (i) return !1
              for (
                var t = ot || ct(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, a = l.tweens.length;
                o < a;
                o++
              )
                l.tweens[o].run(r)
              ...
              if ((u = !C.isEmptyObject(t)) || !C.isEmptyObject(d))
                for (r in (f &&
                  ...
                  'none' === (c = C.css(e, 'display')) &&
                    (l ? (c = l) : (pe([e], !0), (l = e.style.display || l), (c = C.css(e, 'display')), pe([e]))),
              ...
              return 'boolean' == typeof t && r
                ...
                : this.each(function () {
                    ...
                    if (r) for (i = 0, o = C(this), a = bt(e); (t = a[i++]); ) o.hasClass(t) ? o.removeClass(t) : o.addClass(t)
                      ...
                      (void 0 !== e && 'boolean' !== n) ||
                        ((t = xt(this)) && Q.set(this, '__className__', t),
              ...
              ? ((r = y(e)),
                this.each(function (n) {
                  ...
                  1 === this.nodeType &&
                    ...
                    ((t = C.valHooks[this.type] || C.valHooks[this.nodeName.toLowerCase()]) && 'set' in t && void 0 !== t.set(this, i, 'value')) ||
                      (this.value = i))
                }))
              : i
          ...
          C.fn.extend({
            ...
            serializeArray: function () {
              return this.map(function () {
                ...
                .filter(function () {
                  var e = this.type
                  return this.name && !C(this).is(':disabled') && jt.test(this.nodeName) && !Dt.test(e) && (this.checked || !ge.test(e))
                })
                .map(function (e, t) {
                  var n = C(this).val()
                  return null == n
            ...
            ajax: function (e, t) {
              ...
              E.setRequestHeader(
                ...
                d.dataTypes[0] && d.accepts[d.dataTypes[0]]
                  ? d.accepts[d.dataTypes[0]] + ('*' !== d.dataTypes[0] ? ', ' + Ft + '; q=0.01' : '')
                  : d.accepts['*']
              ),
              d.headers))
              ...
              function S(e, t, a, u) {
                ...
                l ||
                  ...
                  f
                    ? (d.ifModified &&
                        ((w = E.getResponseHeader('Last-Modified')) && (C.lastModified[i] = w), (w = E.getResponseHeader('etag')) && (C.etag[i] = w)),
                      204 === e || 'HEAD' === d.type
                        ? (T = 'nocontent')
                        : 304 === e
                        ? (T = 'notmodified')
          ...
          (C.parseHTML = function (e, t, n) {
            return 'string' != typeof e
              ...
              : ('boolean' == typeof t && ((n = t), (t = !1)),
                t ||
                  (v.createHTMLDocument
                    ? (((r = (t = x.implementation.createHTMLDocument('')).createElement('base')).href = x.location.href), t.head.appendChild(r))
                    : (t = x)),
                (o = !n && []),
